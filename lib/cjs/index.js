...
exports.Validot = exports.VLogger = void 0;
/**
...
class VLogger {
    ...
    constructor($debug, $name) {
         ...
         * @param {string} func
         */
        this.info = (className, data, msg, func) => console.log(`${this.$name}[INFO] ${className}.${func}(): "${msg}"`, data);
        /**
         * @param {string} className
         * @param {any} data
         * @param {string} msg
         * @param {string} func
         */
        this.debug = (className, data, msg, func) => console.log(`${this.$name}[DEBUG] ${className}.${func}(): "${msg}"`, data);
        /**
         * @param {string} className
         * @param {any} data
         * @param {string} msg
         * @param {string} func
         */
        this.warn = (className, data, msg, func) => console.log(`${this.$name}[WARN] ${className}.${func}(): "${msg}"`, data);
        /**
         * @param {string} className
         * @param {any} error
         * @param {string} msg
         * @param {string} func
         */
        this.error = (className, error, msg, func) => console.log(`${this.$name}[ERROR] ${className}.${func}(): "${msg}": `, error);
        /**
         * @param {string} className
         */
        this.getVlog = (className = '') => ({
            /**
             * @param {Object} o
             * @param {any} o.data
             * @param {string} o.msg
